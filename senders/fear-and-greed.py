...
def build(data):
    ...
    if value is None:
        return {"bg": "#0A0A1A", "items": [
            {"type": "text", "x": 120, "y": 110, "text": "No data", "font": "sans-12",
    ...
    zone_w = 44
    gauge_x, gauge_y = 10, 150

    items = [
        {"type": "text", "x": 120, "y": 5, "text": "FEAR & GREED", "font": "sans-12",
         "color": "#FFFFFF", "align": "center"},
        {"type": "text", "x": 120, "y": 28, "text": "INDEX", "font": "sans-9",
         "color": "#888888", "align": "center"},
        {"type": "text", "x": 120, "y": 50, "text": str(value), "font": "sans-18",
         "color": color, "align": "center", "maxWidth": "100"},
        {"type": "text", "x": 120, "y": 85, "text": classification, "font": "sans-9",
    ...
    items.append({"type": "text", "x": gauge_x, "y": gauge_y + 18,
                  "text": "Fear", "font": "sans-9", "color": "#FF4444"})
    items.append({"type": "text", "x": gauge_x + zone_w * 5 - 1, "y": gauge_y + 18,
                  "text": "Greed", "font": "sans-9", "color": "#44CC44", "align": "right"})
    items.append({"type": "text", "x": gauge_x, "y": gauge_y + 34,
                  "text": "0", "font": "sans-9", "color": "#666666"})
    items.append({"type": "text", "x": gauge_x + zone_w * 5 - 1, "y": gauge_y + 34,
                  "text": "100", "font": "sans-9", "color": "#666666", "align": "right"})
